...
<FormWrapper
    title="Je gère mon compte"
    customClass="w-full md:w-2/3 lg:w-1/2 my-8"
>
    {#if $message}
        <h3
    ...
    >
        <fieldset class="fieldset gap-4">
            ...
            <!-- ADRESSE -->
            <div>
                <label class="fieldset-label text-info" for="address"
                    >Adresse</label
                >
                <input
                    type="text"
            ...
            <div class="grid md-grid-cols-2 gap-4 md-gap-8 items-end">
                ...
                <!-- Ville -->
                <div>
                    <label class="fieldset-label text-info" for="city"
                        >Ville</label
                    >
                    <input
                        type="text"
